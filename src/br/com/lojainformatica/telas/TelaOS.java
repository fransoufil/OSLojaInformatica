...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    //a linha abaixo cria uma variavel para armazenar um texto conform radiobuton
    private String tipo;
    ...
    private void pesquisar_cliente_orcamento() {
        String sql = "SELECT * FROM tbclientes WHERE idcli = ?";

        try {
            pst2 = conexao.prepareStatement(sql);
            pst2.setString(1, txtCliId.getText());

            rs2 = pst2.executeQuery();
            rs2.beforeFirst();
            rs2.next();

            txtNomedocliente.setText(rs2.getString(2));
    ...
    private void setar_campos_cliente() {
        int setar = tblClientes.getSelectedRow();
        txtNomedocliente.setText(tblClientes.getModel().getValueAt(setar, 1).toString());
    }
    ...
    private void emitir_os() {
        ...
        try {
            ...
            if ((txtCliId.getText().isEmpty()) || (txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty())) {
                ...
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "OSv emitida com sucesso");
    ...
    private void pesquisar_os() {
        //a linha abaixo cria um caixa de entrada
        ...
        try {
            ...
            //tecnica para capturar o erro que quer tratar
    ...
    private void initComponents() {
        ...
        txtData.setFont(new java.awt.Font("Tahoma", 0, 8)); // NOI18N
        ...
        jPanel1.setBounds(20, 12, 0, 0);

        jLabel3.setText("Situação:");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(20, 134, 67, 15);

        cboOsSit.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Na Bancada", "Entrega OK", "Orçamento REPROVADO", "Aguardando Aprovação", "Aguardando Peças", "Abandonado Pelo Cliente", "Retornou" }));
        getContentPane().add(cboOsSit);
        cboOsSit.setBounds(99, 129, 181, 24);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtCliPesquisar, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2.setBounds(290, 0, 0, 158);

        jLabel6.setText("*Equipamento");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(0, 203, 99, 15);

        jLabel7.setText("*Defeito");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(41, 240, 58, 15);

        jLabel8.setText("Serviço");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(48, 277, 51, 15);

        jLabel9.setText("Técnico");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(46, 314, 53, 15);
        getContentPane().add(txtOsEquip);
        txtOsEquip.setBounds(117, 201, 490, 19);
        getContentPane().add(txtOsDef);
        txtOsDef.setBounds(117, 238, 490, 19);
        getContentPane().add(txtOsServ);
        txtOsServ.setBounds(117, 275, 490, 19);

        jLabel10.setText("Valor Total");
        getContentPane().add(jLabel10);
        jLabel10.setBounds(300, 314, 77, 15);
        getContentPane().add(txtOsTec);
        txtOsTec.setBounds(117, 312, 88, 19);

        txtOsValor.setText("0");
        getContentPane().add(txtOsValor);
        txtOsValor.setBounds(434, 312, 173, 19);
        ...
        btnOsAdicionar.setMaximumSize(new java.awt.Dimension(80, 80));
        btnOsAdicionar.setMinimumSize(new java.awt.Dimension(80, 80));
        ...
        btnOsAdicionar.setBounds(44, 337, 80, 80);
        ...
        btnOsPesquisar.setMinimumSize(new java.awt.Dimension(80, 80));
        ...
        btnOsPesquisar.setBounds(142, 337, 80, 80);
        ...
        btnOsAlterar.setBounds(286, 337, 80, 80);
        ...
        btnOsExcluir.setMinimumSize(new java.awt.Dimension(80, 80));
        ...
        btnOsExcluir.setBounds(413, 337, 80, 80);
        ...
        btnOsImprimir.setMaximumSize(new java.awt.Dimension(80, 80));
        btnOsImprimir.setMinimumSize(new java.awt.Dimension(80, 80));
        btnOsImprimir.setPreferredSize(new java.awt.Dimension(80, 80));
        getContentPane().add(btnOsImprimir);
        btnOsImprimir.setBounds(527, 337, 80, 80);

        jLabel11.setText("Cliente");
        getContentPane().add(jLabel11);
        jLabel11.setBounds(160, 170, 50, 15);

        txtNomedocliente.setEnabled(false);
        getContentPane().add(txtNomedocliente);
        txtNomedocliente.setBounds(220, 170, 250, 19);
    ...
    private void rbtOrcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtOrcActionPerformed
        // atribuindo um texto a variavle tipo
        tipo = "Orçamento";
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        // qd form abre programa ação marcando radiobuton orçamento
        rbtOrc.setSelected(true);
        tipo = "Orçamento";
